...
export default function BookingPage() {
  ...
  useEffect(() => {
    api.get('/menu/blocked-dates').then(r => {
      setBlockedDates(r.data.map(d => d.date?.split('T')[0]))
    }).catch(() => {})
  }, [])
  ...
  return (
    <div className="booking-page">
      ...
      <div className="booking-header">
        ...
        <span className="booking-header-title">Book Your Catering</span>
        <span className="booking-step-label">Step 1 / 3</span>
      </div>
      <div className="booking-progress">
        <div className="booking-progress-fill" style={{ width: '33%' }} />
      </div>
      ...
      <div className="booking-body">
        ...
        <div className="booking-card">
          <h2 className="booking-card-title">
            <i className="fa-solid fa-calendar-star" style={{ marginRight: 10 }} />
            Select Event Type
          </h2>
        ...
        <div className="booking-card">
          <h2 className="booking-card-title">
            <i className="fa-solid fa-location-dot" style={{ marginRight: 10 }} />
            Venue Address
          </h2>
          <div className="field-block" style={{ marginBottom: 0 }}>
            <input
        ...
        <div className="booking-card">
          <h2 className="booking-card-title">
            <i className="fa-solid fa-plate-utensils" style={{ marginRight: 10 }} />
            Serving Style
          </h2>
      ...
      <div className="booking-fixed-bar">
        <div className="booking-fixed-inner">
          <div>
            <p style={{ fontSize: '0.72rem', letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--text-muted)', marginBottom: 2 }}>Event Selection</p>
            <p style={{ fontSize: '0.92rem', color: eventType ? 'var(--gold)' : 'var(--text-faint)', fontFamily: 'var(--font-display)' }}>
              {eventType || 'No event selected'}{eventType && eventDate ? ` · ${eventDate}` : ''}
            </p>
          </div>
          <button onClick={handleContinue} className="btn btn-primary">
            Continue to Menu Builder <i className="fa-solid fa-arrow-right" style={{ marginLeft: 4 }} />
          </button>
        </div>
      </div>
    </div>
