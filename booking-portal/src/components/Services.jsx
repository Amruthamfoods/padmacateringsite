const STEPS = [
  { n: '01', icon: 'fa-solid fa-box-open', title: 'Choose Package', desc: 'Browse Meal Tray, Bulk Delivery or Full Catering options that suit your event size and budget.' },
  ...
  { n: '04', icon: 'fa-solid fa-truck-fast', title: 'We Deliver', desc: 'We handle cooking, packaging, delivery and serving if you choose Full Catering.' },
]
