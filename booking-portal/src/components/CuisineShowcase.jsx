...
const CATEGORIES = [
  { id: 'meal-tray', icon: 'fa-solid fa-box', title: 'Meal Tray', tag: 'Individual Packs', color: '#E8F5E9', iconColor: '#2E7D32', image: '/img/meal-tray.jpg', desc: 'Hygienic individual meal trays — order 10 trays, get 10 perfectly packed meals. Ideal for offices, workshops and small gatherings.', features: ['Breakfast / Lunch / Dinner trays', 'Min 10 trays per order', 'Fully packed & hygienic', 'Veg & Non-Veg options'] },
  { id: 'bulk-delivery', icon: 'fa-solid fa-truck', title: 'Delivery Box', tag: 'Large Quantities', color: '#E3F2FD', iconColor: '#1565C0', image: '/img/delivery-box.png', desc: 'Each dish delivered in its own large box — perfect for self-service events. Optional serving staff available as add-on.', features: ['Separate containers per dish', 'South & North Indian', 'Optional serving staff', 'Min 25 guests'] },
  { id: 'catering', icon: 'fa-solid fa-hat-chef', title: 'Catering', tag: 'Complete Service', color: '#F3E5F5', iconColor: '#6A1B9A', image: '/img/catering.jpeg', desc: 'We handle everything — cooking, delivery, live setup, professional serving staff and complete cleanup after your event.', features: ['Full buffet setup', 'Trained serving staff', 'Live counters available', 'Weddings & large events'] },
]
