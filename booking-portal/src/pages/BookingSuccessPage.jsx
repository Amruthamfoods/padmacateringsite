    ...
    <div className="success-page">
      <div className="success-card">
        ...
        <div className="success-actions">
          <a href="https://padmacatering.com/booking/" className="btn btn-outline">
            <i className="fa-solid fa-plus" /> {isQuote ? 'New Request' : 'Book Another'}
          </a>
        </div>

        <p style={{ marginTop: 20 }}>
          <a href="https://padmacatering.com" style={{ fontSize: '0.82rem', color: 'var(--text-muted)', textDecoration: 'none' }}>← Back to Home</a>
        </p>
      </div>
    </div>
  )
