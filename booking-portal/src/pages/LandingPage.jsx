...
export default function LandingPage() {
  ...
  return (
    <div className="booking-page" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '40px 20px' }}>
      <a href="https://padmacatering.com" style={{ position: 'absolute', top: 20, left: 20, fontSize: '0.82rem', color: 'var(--text-muted)', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 6 }}>
