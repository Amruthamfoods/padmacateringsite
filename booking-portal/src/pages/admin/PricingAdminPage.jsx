        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24, marginBottom: 24 }}>
          ...
          <div className="admin-card">
            ...
            <div style={{ padding: 20 }}>
              {field('Packing Cost', 'packingCostPercent', '% of base food price added for packing', '% of food total')}
          ...
          <div className="admin-card">
            ...
            <div style={{ padding: 20 }}>
              {field('Setup & Service Fee', 'cateringDelivery', 'Fixed setup & service charge for catering events (transport charged separately)', 'Rs')}
          ...
          <div className="admin-card">
            ...
            <div style={{ padding: 20 }}>
              ...
              {[
                ...
                ['Packing Charge (Mealbox/Packed)', '₹' + Math.round(100 * 250 * form.packingCostPercent / 100).toLocaleString('en-IN')],
