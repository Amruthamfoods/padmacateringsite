...
const NAV = [
  ...
  { to: '/admin/rewards', label: 'Rewards', icon: 'fa-solid fa-star' },
  { to: '/admin/delivery', label: 'Delivery', icon: 'fa-solid fa-truck' },
    { to: '/admin/pricing', label: 'Pricing', icon: 'fa-solid fa-tag' },
]
